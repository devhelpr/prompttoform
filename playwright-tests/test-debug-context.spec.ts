...
test('Debug Context Test - Simple Expression', async ({ page }) => {
  // Read the test JSON file
  const formJson = fs.readFileSync('debug-context-test.json', 'utf8');
