...
// Test form that matches the user's example
const healthCheckForm: FormDefinition = {
  app: {
...
export function testFixedConditionalValidation() {
  console.log('=== FIXED CONDITIONAL VALIDATION TEST ===');

  const schema = generateJsonSchema(healthCheckForm);
...
if (typeof window !== 'undefined') {
  (window as any).testFixedConditionalValidation =
    testFixedConditionalValidation;
}
